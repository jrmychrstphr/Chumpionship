...
list_of_other_files = [x for x in list_of_templates_folder_contents if not x.endswith(".html") or x.endswith(".html") and x.startswith("html-")]
list_of_html_files = [x for x in list_of_templates_folder_contents if x.endswith(".html") and not x.startswith("html-")]
