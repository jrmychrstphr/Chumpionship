...
"Jeremy Harding (1035711)": {
	
	// added on first pass (i.e pulled straight from scraped data)
	"fpl_code"
	"manager_name"
	"team_name"
	"fixture_score_array"
	...
	// added on second pass (fixture results)
	"fixture_result_array" // needs a fixture list to draw opponent info from
	"league_points_total_array"
	"fixture_points_running_total_array"

	// added on third pass (league standings)
	"league_position_array" //I need to calculate weekly positions based on results
